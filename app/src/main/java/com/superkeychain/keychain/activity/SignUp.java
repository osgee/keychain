...
public class SignUp extends AppCompatActivity implements View.OnClickListener {
 ...
 /*   @Override
    ...
    @Override
    public boolean onOptionsItemSelected(MenuItem graphic_password_item) {
        // Handle action bar graphic_password_item clicks here. The action bar will
        // automatically handle clicks on the Home/Up button, so long
        // as you specify a parent activity in AndroidManifest.xml.
        int id = graphic_password_item.getItemId();
        ...
        return super.onOptionsItemSelected(graphic_password_item);
    }*/
}
