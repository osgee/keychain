...
import com.superkeychain.keychain.entity.Point;
import com.superkeychain.keychain.utils.ScreenUtils;
...
//		bitmap = Bitmap.createBitmap(480, 854, Bitmap.Config.ARGB_8888); // 设置位图的宽高
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:// 当手指抬起的时候
			...
			//验证用户绘制的密码手势的密码
			callBack.doWithPassword(passwordSb.toString());
	...
	public interface GestureCallBack{
		 ...
		 * 代表用户绘制的密码与传入的密码相同
		 */
		void doWithPassword(String password);
	}
